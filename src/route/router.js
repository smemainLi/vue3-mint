...
const router = new Router({
  ...
  routes: [
    ...
    { path: '/order/appointmentProtocol', meta: { title: '预约须知' }, name: 'protocol', component: routerPath.protocol },
    ...
    { path: '/mcard/userProtocol', meta: { title: '会员卡协议' }, name: 'protocol', component: routerPath.protocol },
